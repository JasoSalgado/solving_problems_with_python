...
"""
# A Counter is a dictionary subclass for counting hashable objects. Elements are stored as dictionary keys, and their counts are stored as dictionary values.
# It helps to keep track of the sentence scoring
...
def get_word_freq(speech_edit_no_stop):
    """Return a dictionary of word frequency is a string"""
