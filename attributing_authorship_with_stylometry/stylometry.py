"""
Stylometry is the quantitative study of literary
style through computational text analysis. It’s based on the idea that we all have a
unique, consistent, and recognizable style to
our writing. This includes our vocabulary, our use of
punctuation, the average length of our sentences and
words, and so on
"""
import nltk
...
def word_length_test(words_by_author, len_shortest_corpus):
    """Plot words length freq by author, truncated to shortest corpus length"""
...
# Jaccard similarity coefficient also called the intersection over union
